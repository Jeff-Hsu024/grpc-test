...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<custom.tibame201020.grpc_client.proto.HelloRequest,
      custom.tibame201020.grpc_client.proto.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = custom.tibame201020.grpc_client.proto.HelloRequest.class,
      responseType = custom.tibame201020.grpc_client.proto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<custom.tibame201020.grpc_client.proto.HelloRequest,
      custom.tibame201020.grpc_client.proto.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<custom.tibame201020.grpc_client.proto.HelloRequest, custom.tibame201020.grpc_client.proto.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<custom.tibame201020.grpc_client.proto.HelloRequest, custom.tibame201020.grpc_client.proto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  custom.tibame201020.grpc_client.proto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  custom.tibame201020.grpc_client.proto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(custom.tibame201020.grpc_client.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<custom.tibame201020.grpc_client.proto.HelloResponse> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(custom.tibame201020.grpc_client.proto.HelloRequest request,
        io.grpc.stub.StreamObserver<custom.tibame201020.grpc_client.proto.HelloResponse> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public custom.tibame201020.grpc_client.proto.HelloResponse sayHello(custom.tibame201020.grpc_client.proto.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<custom.tibame201020.grpc_client.proto.HelloResponse> sayHello(
        custom.tibame201020.grpc_client.proto.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((custom.tibame201020.grpc_client.proto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<custom.tibame201020.grpc_client.proto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              custom.tibame201020.grpc_client.proto.HelloRequest,
              custom.tibame201020.grpc_client.proto.HelloResponse>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return custom.tibame201020.grpc_client.proto.GreeterProto.getDescriptor();
    }
